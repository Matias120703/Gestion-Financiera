...
export const es = {
  ...
  deudas: {
    ...
    siEliminar: 'Sí, eliminar',
    deshacerPago: 'Deshacer este pago',
    confirmarDeshacer: '¿Deshacer este pago?',
    deshacerDetalle: 'Vuelve el saldo, la cuota y el vencimiento, y el gasto queda anulado.',
    siDeshacer: 'Sí, deshacer',
    revisaElVencimiento: 'Listo. Revisá la fecha de vencimiento: este pago es de antes y no guardó cuál era.',
