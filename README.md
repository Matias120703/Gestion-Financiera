...
La aplicación usa una librería de Excel desde CDN para generar archivos `.xlsx`. Para que varios usuarios compartan datos en tiempo real, el siguiente paso recomendado es agregar autenticación y una base de datos central (por ejemplo, Supabase o PostgreSQL).
